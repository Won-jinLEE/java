...
public class ClassRoom {
	...
	public void classScoreInfo() {
		...
		System.out.println(this.name+"반의 남학생의 중간고사 평균은 "+((maleMiKOR+maleMiENG+maleMiMATH)/(3*maleCount))+"점");
		...
		System.out.println(this.name+"반의 남학생의 기말고사 총점은 "+(maleFiKOR+maleMiENG+maleFiMATH)+"점");
		System.out.println(this.name+"반의 남학생의 기말고사 평균은 "+((maleFiKOR+maleMiENG+maleFiMATH)/(3*maleCount))+"점");
		...
		System.out.println(this.name+"반의 여학생의 중간고사 평균은 "+((femaleMiKOR+femaleMiENG+femaleMiMATH)/(3*femaleCount))+"점");
		...
		System.out.println(this.name+"반의 여학생의 기말고사 평균은 "+((femaleFiKOR+femaleFiENG+femaleFiMATH)/(3*femaleCount))+"점");
	}
